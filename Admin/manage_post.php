                ...
                <table class="table table-striped table-advance table-hover">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="btn-group">
                          <a class="btn btn-danger" name="remove" href="../includes/remove_post.php?id=<?=$post['id']?>" onclick="return checkdelete()"><i class="icon_close_alt2"></i></a>
                          <a class="btn btn-primary" name="edit" href="../includes/edit_post_form.php?id=<?=$post['id']?>" ><i class="icon_plus_alt2"></i></a>
                        </div>
                      </td>
