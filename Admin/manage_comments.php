                ...
                <table class="table table-striped table-advance table-hover">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?=$count?></td>
                      <td><?=$comment['name']?></td>
                      <td><?=getPostName($conn,$comment['post_id'])?></td>
                      <td><?=$comment['comment']?></td>
                      <td><?=date('F jS, Y', strtotime($comment['created_at']));?></td>
                      <td>
                        <div class="btn-group">
                          <a class="btn btn-danger" name="remove" href="../includes/remove_comment.php?id=<?=$comment['id']?>" onclick="return checkdelete()"><i class="icon_close_alt2"></i></a>
                        </div>
                      </td>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form role="form" action="../includes/add_menus.php" method="post">
                  
                  <div class="form-group">
                    <label for="Category">Menu Title</label>
                    <input type="text" class="form-control" name="menu-name" id="" placeholder="Enter Menu Title..." required>
                  </div>

                  <div class="form-group">
                    <label for="Category">Menu Link</label>
                    <input type="text" class="form-control" name="menu-link" id="" value="#" placeholder="Enter Menu Link..." required>
                  </div>
