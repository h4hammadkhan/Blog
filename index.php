  ...
  <div class="container m-auto mt-3 row">
        <div class="col-8">
          ...
          if(isset($_GET['search'])){
            $keyword = $_GET['search'];
            $sql = "SELECT * FROM posts WHERE title LIKE '%$keyword%' ORDER BY id DESC LIMIT $show,$post_per_page";
          }
          else{
            $sql = "SELECT * FROM posts ORDER BY id DESC LIMIT $show,$post_per_page";
          ...
          ?>
            ...
            <div class="card mb-3" style="max-width: 800px;">
              <a href="post.php?id=<?=$post['id']?>" style="text-decoration:none; color:black;">
                <div class="row g-0">
                  <div class="col-md-5" style="background-image: url('img/<?=getPostThumb($conn,$post['id'])?>');background-size: cover">
                    <!-- <img src="https://images.moneycontrol.com/static-mcnews/2020/04/stock-in-the-news-770x433.jpg" alt="..."> -->
                  </div>
                  <div class="col-md-7">
                    <div class="card-body">
                      <h5 class="card-title"><?=$post['title']?></h5>
                      <div class="card-text text-truncate" style="height:65px;"><?=$post['content']?></div>
...
?>
  ...
  <nav aria-label="Page navigation example" class="fixed-bottom2">
    ...
    ?>
        ...
        ?>
          ...
          <li class="page-item"><a class="page-link" href="?<?php if(isset($_GET['search'])){echo "search=$keyword&";}?>page=<?=$lpage?>"><?=$lpage?></a></li>
