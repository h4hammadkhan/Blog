    ...
    <section id="main-content">
        ...
        <h4 class="modal-title">Edit Menu</h4>
            ...
            <div class="modal-body">
                ...
                <form role="form" name="myform" onsubmit="return validateform()" action="edit_menu.php?id=<?=$data['id']?>" method="post">
                    
                    <div class="form-group">
                        <label for="Category">Edit Menu Name</label>
                        <input type="text" class="form-control" name="menu-name" id="name" value="<?=$data['name']?>" placeholder="Enter Category Name...">
                        <small class="formerror"></small>
                    </div>

                    <div class="form-group">
                        <label for="Category">Edit Menu Link</label>
                        <input type="text" class="form-control" name="menu-link" id="link" value="<?=$data['action']?>" placeholder="Enter Menu Link...">
                        <small class="formerror"></small>
                    </div>
                    
                    <button type="submit" name="editmenu" class="btn btn-primary" onclick="return checkEdit()">Edit</button>
                </form>
            </div>
  ...
  <script>
    ...
    <script>
          ...
          function validateform() {
            ...
            if(title.length==0){
              seterrortitle("name", "*Title cannot be blank!");
              returnval = false;
            }
