...
<body>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
        ...
        <?php       
                    $edit_id = $_GET['id'];
                    $sql = "SELECT * FROM submenu WHERE id=$edit_id";
        ...
        <h4 class="modal-title">Edit SubMenu</h4>
            ...
            <form role="form" name="myform" onsubmit="return validateform()" action="edit_submenu.php?id=<?=$data['id']?>" method="post">
                  
                <div class="form-group">
                <label for="Category">Edit SubMenu Title</label>
                <input type="text" class="form-control" name="submenu-name" id="subname" value="<?=$data['name']?>" placeholder="Enter SubMenu Title..." >
                ...
                <select type="text" class="form-control" name="parent-id">
                    ...
                    <option value="<?=$menu['id']?>"
                      <?php
                            if($data['parent_menu_id']== $menu['id']){
                              echo "selected";
                            }
                      ?>
                    ><?=$menu['name']?></option>
                ...
                <div class="form-group">
                <label for="Category">Edit SubMenu Link</label>
                <input type="text" class="form-control" name="submenu-link" id="sublink" value="<?=$data['action']?>" placeholder="Enter SubMenu Link...">
                <small class="formerror"></small>
                </div>
                  
                <button type="submit" name="editsubmenu" class="btn btn-primary" onclick="return checkEdit()">Edit</button>
            </form>
            </div>
  ...
  <script>
     function clearerrors() {
          ...
          function validateform() {
            var returnval = true;
            clearerrors();
            var title = document.forms['myform']["subname"].value;
            var link = document.forms['myform']["sublink"].value;
